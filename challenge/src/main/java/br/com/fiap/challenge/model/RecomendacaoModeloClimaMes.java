...
public class RecomendacaoModeloClimaMes {
	private ModeloCaminhao modeloCaminhao;
	private ClimaMes climaMes;
	...
	public ClimaMes getClimaMes() {
		return climaMes;
	}
	
	public void setClimaMes(ClimaMes climaMes) {
		this.climaMes = climaMes;
	}
